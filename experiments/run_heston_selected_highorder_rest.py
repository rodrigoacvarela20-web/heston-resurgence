...
cases=[('rho',-.9),('rho',0.0),('xi',.25),('xi',.8),('kappa',.75),('kappa',4.0)]
...
with open(path,'a',newline='',encoding='utf-8') as f:
 ...
 for a,v in cases:
  label=f'{a}_{v}';print('RUN',label,flush=True)
  r=high_order_case((a,v,32));r={'label':label,**r};w.writerow(r);f.flush()
